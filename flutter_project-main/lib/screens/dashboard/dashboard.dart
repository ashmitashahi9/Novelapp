...
import 'package:n_baz/screens/epub/epub_viewer.dart';
import 'package:n_baz/screens/epub/eupb_adds_creen.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: PageView(
          ...
          children: <Widget>[HomeScreen(), FavoriteScreen(), AccountScreen(), EpubAddScreen()],
